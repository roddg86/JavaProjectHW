...
public class Ex001_Program {
    public static void main(String[] args) {
        // клиентский код, работает с экземпляром нашего класса
        // создаем экземпляр класса, конструктор
        ...
        System.out.println(w1 == w4); // разные поля
        System.out.println(w1.equals(w4)); // разные поля
